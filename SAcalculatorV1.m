...
%F=M*a, seperating to 2 point masses: front mass, and rear mass. Using
%momemnt balance? doensnt matter I guess, same thing in this case.

Fflat=glat*wf; %total front force, resisted proportionally by tire dynamic loads
Frlat=glat*wr; %total rear force, resisted proportionally by tire dynamic loads (transferred) 

%now it must seek NFYs: 
