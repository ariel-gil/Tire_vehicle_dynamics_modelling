...
load('G:\My Drive\RFR\Ryerson Formula Racing\RF-18\Engineering\Vehicle Dynamics\Suspension\Tire Study GC\A1654run21.mat')
...
%SA input. 
%Fl, FR, Rl, RR. For positive Glat, 
%[insideF (light), outsideF (heavy),%inside R, outside R] 
saval=[11,-11,11,-11];
