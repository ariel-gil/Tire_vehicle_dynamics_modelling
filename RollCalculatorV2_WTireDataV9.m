...
%% 
%trans (using Roll Couple) (RollCalculatorV1.m, in suspension - matlab)

Ksarbf=150; %Enter front antiroll stiffness
Ksarbr=150; 

[dWf,dWr]=RollCalculatorV1(Ksarbf,Ksarbr)

longtrans=((h/l)*m*glong)/2;
%% 
saval=[12.6,-12.6,12.3,-12.3];
%loads: Dynamic 
%fl 1
%fr 2
%rl 3
%rr 4
Ldyn=[fls-dWf;frs+dWf;rls-dWr;rrs+dWr;]
